...
var getReorderImpact = (function (_ref) {
  var targetRect = _ref.pageBorderBoxWithDroppableScroll,
      draggable = _ref.draggable,
      destination = _ref.destination,
      insideDestination = _ref.insideDestination,
      last = _ref.last,
  ...
  for (var i = 0; i < insideDestination.length; i++) {
    var child = insideDestination[i];
    var id = child.descriptor.id;
    var didStartAfterCritical$1 = didStartAfterCritical(id, afterCritical);
    var childCenterXY = child.page.borderBox.center;
